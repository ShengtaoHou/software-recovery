...
public class AmqpNioTransport extends TcpTransport
{
    ...
    public AmqpNioTransport(final WireFormat wireFormat, final SocketFactory socketFactory, final URI remoteLocation, final URI localLocation) throws UnknownHostException, IOException {
        super(wireFormat, socketFactory, remoteLocation, localLocation);
        this.amqpNioTransportHelper = new AmqpNioTransportHelper(this);
        this.magicRead = false;
    }
    
    public AmqpNioTransport(final WireFormat wireFormat, final Socket socket) throws IOException {
    ...
    protected void initializeStreams() throws IOException {
        ...
        this.selection = SelectorManager.getInstance().register(this.channel, new SelectorManager.Listener() {
            ...
            public void onError(final SelectorSelection selection, final Throwable error) {
                AmqpNioTransport.LOG.trace("Error detected: {}", error.getMessage());
    ...
    private void serviceRead() {
        try {
            while (this.isStarted()) {
                ...
                this.amqpNioTransportHelper.processCommand(this.inputBuffer);
    ...
    static {
        LOG = LoggerFactory.getLogger(AmqpNioTransport.class);
    }
}
